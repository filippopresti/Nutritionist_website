...
(function () {
  ...
  function footer() {
    ...
    return (
      ...
      '<li class="flex items-start gap-3 text-verde-200/85"><a data-href="maps" href="#"><span class="mt-0.5 h-4 w-4 shrink-0">' + ICONE.posizione + "</span>" + esc(S.studio.indirizzoCompleto) + "</a></li>" +
      "</ul></div></div>" +
